...
- (NSString *)enTimerContraAhora
{
    ...
    if (!diasListo) {
        dias = [NSString stringWithFormat:@"%d %@", (int)((-1) * [conversionInfo day]), NSLocalizedString(@"días", @"días")];
    }
    if (!horasListo)
        horas = [NSString stringWithFormat:@"%d %@", (int)((-1) * [conversionInfo hour]), NSLocalizedString(@"horas", @"horas")];
    if (!minsListo)
        mins = [NSString stringWithFormat:@"%d %@", (int)((-1) * [conversionInfo minute]), NSLocalizedString(@"mins", @"mins")];
